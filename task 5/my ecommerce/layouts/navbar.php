                                ...
                                <ul>
                                    ...
                                    <li class="mega-menu-position top-hover"><a href="shop.php">shop</a>
                                        ...
                                        <?php foreach($categoriesData as $category){ 
                                                    ...
                                                    $subcategories = $subcategoriesModel->setCategory_id($category['id'])->getByCategoryId();
                                                    ?>
                                            <li>
                                                <!-- loop categories -->
                                                
                                                <ul>
                                                    <li class="mega-menu-title"><a class="font-weight-bold" href="shop.php?category_id=<?= $category['id'] ?>"><?= $category['name_en']?></a></li>
                                                    <?php foreach($subcategories as $subcategory){  ?>
                                                    <li><a href="shop.php?subcategory_id=<?= $subcategory['id'] ?>"><?= $subcategory['name_en'] ?></a></li>
