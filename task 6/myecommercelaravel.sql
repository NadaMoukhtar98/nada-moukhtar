...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 29, 2022 at 01:48 AM
...
INSERT INTO `admins` (`name`, `email`, `phone`, `password`, `updated_at`, `created_at`) VALUES
('nada', 'neetu.dandn@yahoo.com', '01013149599', 'Nada@66129312', '2022-10-28 23:03:31', '2022-10-29 23:03:31'),
('nada', 'neetu.dandn@yahoo.com', '01013149599', 'Nada@66129312', '2022-10-28 23:03:31', '2022-10-29 23:03:31');
...
CREATE TABLE `products_details` (
  ...
  `details_en` varchar(32) DEFAULT NULL,
  `details_ar` varchar(32) DEFAULT NULL,
  ...
  `subcategory_name_en` varchar(32) DEFAULT NULL,
  `brand_name_en` varchar(32) DEFAULT NULL,
...
CREATE TABLE `reviews_details` (
  ...
  `product_name_en` varchar(32) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `users_orders_reviews`
--
